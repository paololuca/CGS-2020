...
{
    public partial class Quarti : Form
    {
        int idTorneo = 0;
        int idDisciplina = 0;
        ...
        public Quarti(List<AtletaEliminatorie> campo1,
                            List<AtletaEliminatorie> campo2,
                            List<AtletaEliminatorie> campo3,
                            List<AtletaEliminatorie> campo4,
                            int idTorneo,
        ...
        private void buttonSalvaCampo1_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow r in dataGridViewCampo1.Rows)
            {
                ...
                Helper.EliminaSemifinaliByCampo(1, idTorneo, idDisciplina, (int)r.Cells[0].Value);
                Helper.EliminaSemifinaliByCampo(1, idTorneo, idDisciplina, (int)r.Cells[5].Value);

                Helper.UpdateQualificati8(idTorneo, idDisciplina, 1, posizione, (int)r.Cells[0].Value, (int)r.Cells[4].Value, (int)r.Cells[9].Value);
                Helper.UpdateQualificati8(idTorneo, idDisciplina, 1, posizione, (int)r.Cells[5].Value, (int)r.Cells[9].Value, (int)r.Cells[4].Value);
        ...
        private void buttonSalvaCampo2_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow r in dataGridViewCampo2.Rows)
            {
                ...
                Helper.EliminaSemifinaliByCampo(2, idTorneo, idDisciplina, (int)r.Cells[0].Value);
                Helper.EliminaSemifinaliByCampo(2, idTorneo, idDisciplina, (int)r.Cells[5].Value);

                Helper.UpdateQualificati8(idTorneo, idDisciplina, 2, posizione, (int)r.Cells[0].Value, (int)r.Cells[4].Value, (int)r.Cells[9].Value);
                Helper.UpdateQualificati8(idTorneo, idDisciplina, 2, posizione, (int)r.Cells[5].Value, (int)r.Cells[9].Value, (int)r.Cells[4].Value);
        ...
        private void buttonSalvaCampo3_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow r in dataGridViewCampo3.Rows)
            {
                ...
                Helper.UpdateQualificati8(idTorneo, idDisciplina, 3, posizione, (int)r.Cells[0].Value, (int)r.Cells[4].Value, (int)r.Cells[9].Value);
                Helper.UpdateQualificati8(idTorneo, idDisciplina, 3, posizione, (int)r.Cells[5].Value, (int)r.Cells[9].Value, (int)r.Cells[4].Value);
        ...
        private void buttonSalvaCampo4_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow r in dataGridViewCampo4.Rows)
            {
                ...
                Helper.UpdateQualificati8(idTorneo, idDisciplina, 4, posizione, (int)r.Cells[0].Value, (int)r.Cells[4].Value, (int)r.Cells[9].Value);
                Helper.UpdateQualificati8(idTorneo, idDisciplina, 4, posizione, (int)r.Cells[5].Value, (int)r.Cells[9].Value, (int)r.Cells[4].Value);
        ...
        private void buttonNextPhase_Click(object sender, EventArgs e)
        {
            ...
            campo1 = Helper.GetSemifinali(idTorneo, idDisciplina, 1);
            campo2 = Helper.GetSemifinali(idTorneo, idDisciplina, 2);

            Form semiFinali = new Semifinali(campo1, campo2, idTorneo, idDisciplina);
        ...
        private void buttonStampa_Click(object sender, EventArgs e)
        {
            ...
            pdf.StampaQuarti(campo1, campo2, campo3, campo4);
        }
    }
}
